class Slot{
  constructor(x,y,width,height){
    ...
    this.hitbox = new Dragable(
      {x: x, y:y, width:width, height:height, color:grad, outline:{thickness:2,color:"black"}, spriteOffsetY: - height/3, draw:null, drawArgs:[true,true,false,true,true,true], mouseDrawArgs:[false,true]},
      null,
